    ...
    <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          <span class="sr-only">MA Jauharul Ulum</span>
          <img src="{{ asset('asset/logo/MA.png') }}" alt="Logo MA" class="h-8 w-auto" />
        </a>
      </div>
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="/posts" class="text-sm/6 font-semibold text-white">News</a>
        <a href="/contact" class="text-sm/6 font-semibold text-white">Contact</a>
        <a href="/ppdb" class="text-sm/6 font-semibold text-white">PPDB</a>
      </div>
            ...
            <div class="mt-6 flow-root">
              <div class="-my-6 divide-y divide-white/10">
                <div class="space-y-2 py-6">
                    ...
                    <a href="/posts" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">News</a>
                    <a href="/contact" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Contact</a>
                    <a href="/ppdb" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">PPDB</a>
                </div>
                <div class="py-6">
